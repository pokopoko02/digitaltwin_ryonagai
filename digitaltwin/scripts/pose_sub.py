...
def offboard_node():
    ...
    test=rospy.Subscriber("test2",PoseStamped,queue_size=10)
    test2=rospy.Publisher("test3",PoseStamped,queue_size=10)
#    print(rospy.Subscriber("test",PoseStamped,queue_size=10))
    #print(test)
