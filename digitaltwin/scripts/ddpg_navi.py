...
class ddpg_navi():
    ...
    def navigation(self):
        ...
        while not rospy.is_shutdown():
            ...
            pub_vel.linear.x = pub_vel.linear.x*0.4#速度制限用
            pub_vel.angular.z = pub_vel.angular.z*0.4
            
            #ここにobserve_dataの一番後ろにゴール情報入ってるからその辺でいじればゴール処理かえれそう・
